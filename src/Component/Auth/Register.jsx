...
const Register = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-base-200 p-4 pt-8">
            ...
            >
                ...
                <form onSubmit={handleSubmit(handleRegister)}>
                    ...
                    <motion.button
                        ...
                        justify-center gap-2 text-sm font-medium hover:bg-base-200 duration-200"
