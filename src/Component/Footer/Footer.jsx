...
const Footer = () => {
  return (
    <footer className="bg-base-300 text-base-content py-16 px-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 opacity-70 text-sm">
            <li className="flex items-center gap-2 hover:opacity-100 transition cursor-pointer">
              <FaEnvelope /> rakibhasan.dev1@gmail.com
            </li>
            <li className="flex items-center gap-2 hover:opacity-100 transition cursor-pointer">
              <FaPhone /> +880 1234 567890
            </li>
            <li className="text-sm mt-2">Dhaka, Bangladesh</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 flex flex-col opacity-70 text-sm">
        ...
        <div>
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="hover:opacity-70 transition transform hover:scale-110"
            >
